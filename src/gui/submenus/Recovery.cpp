...
void GUI::Submenus::Recovery()
{
	...
	if (GUI::Option("Unlock All", "Unlocks many unlockable GTA Online items"))
	{
		...
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_DRIV")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_FLY")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_LUNG")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_MECH")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_SHO")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_STAM")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_STL")), 100, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SCRIPT_INCREASE_STRN")), 100, true);
	...
	if (GUI::Option("Unlock Tattoo's", "Unlock most tattoo's"))
	{
		...
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_AWD_FMBBETWIN")), 50000, 1);
		...
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_DB_PLAYER_KILLS")), 1000, 1);
	}
	...
	{
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_1")), 690, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_2")), 1860, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_3")), 2690, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_4")), 2660, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_5")), 2650, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_HIGHSCORE_6")), 450, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_TARGETS_HIT")), 269, true);
		STATS::STAT_SET_INT(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_WEAPON_BIT_SET")), 0xFFFFFFFF, true);
		STATS::STAT_SET_BOOL(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_TIER_1_REWARD")), true, true);
		STATS::STAT_SET_BOOL(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_INCREASE_THROW_CAP")), true, true);
		STATS::STAT_SET_BOOL(MISC::GET_HASH_KEY(helper::StringToChar(Game::gtao::get_current_character() + "_SR_TIER_3_REWARD")), true, true);
	}
	...
	{
		std::string Rank;
		if (Game::keyboard::get_input("Enter desired rank", Rank, 1, 4) == Game::keyboard::input_status::SUCCESS)
		{
